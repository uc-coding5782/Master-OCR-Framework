"""
Basic OCR example using the framework.

This example demonstrates how to process a single image using PaddleOCR
...
def main() -> None:
    """Run basic OCR on a sample image."""
    # Create a pipeline with PaddleOCR
